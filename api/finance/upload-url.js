...
const { parseFinanceUploadUrlPayload } = require('../../lib/finance-validation');
const { generateFinanceUploadUrl } = require('../../lib/finance-service');
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    return sendHandledError(res, 'finance/upload-url', error);
  }
};
