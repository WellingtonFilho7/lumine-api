...
const DEFAULT_ALLOWED_MIME = ['application/pdf', 'image/jpeg', 'image/png', 'image/webp'];
const MIME_EXT_MAP = {
  'application/pdf': ['pdf'],
  'image/jpeg': ['jpg', 'jpeg'],
  'image/png': ['png'],
...
function createFinanceService(deps = {}) {
  ...
  async function createTransaction(payload, actor) {
    ...
    const row = {
      ...
      comprovante_mime: payload.comprovanteMime || null,
